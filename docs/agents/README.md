...
| Reading CI run #117 against the programme's predictions (regime placement, waste-term channel, dose grid, run_id hashing, aggregate profile-path failure) | [Run #117 wave readout](run-117-wave-readout.md) |
