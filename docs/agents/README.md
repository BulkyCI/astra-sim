...
| Changing packet loss, control traffic, priority classes, or recovery | [Loss-tolerant RDMA decision](loss-tolerant-rdma-decision.md) |
...
4. Read the [ASTRA-sim pivot](ring-3d-astra-pivot.md) to distinguish the
	current model from the paper; it does not prescribe a remedy.
5. Load the local [glossary](../../experiments/ring_3d/GLOSSARY.md) and
...
6. Treat [the validation protocol](../../experiments/ring_3d/VALIDATION_PROTOCOL.md)
