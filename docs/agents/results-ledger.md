...
| the design-of-record sweep | #132 | budget 0.05: 14.2 to 15.4 % for 3.8 %; 0.1 (five seeds): 15.7 to 16.9 % for 7.5 to 7.6 %; 0.2: 17.7 to 18.6 % for 13.3 to 13.5 %; 0.4: 18.3 to 18.4 % for 16.1 to 16.4 %; 0.6: 17.5 to 18.4 % for 16.1 to 17.2 % (loss saturates, trims run out); schedule off at 0.4: 20.3 to 22.5 % for 20.0 to 20.8 % |
...
| `direct2` 2:1 at budget 0.1 | #132 | 5.8 to 6.5 % for 0.89 to 0.93 % |
